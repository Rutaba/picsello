defmodule Picsello.EmailAutomation.EmailAutomationPipeline do
  ...
  @states_by_type %{
    lead: ~w(manual_thank_you_lead client_contact manual_booking_proposal_sent lead)a,
    job:
      ~w(job post_shoot shoot_thanks offline_payment paid_offline_full paid_full balance_due before_shoot booking_event pays_retainer pays_retainer_offline booking_proposal payment_confirmation_client shoot_reminder)a,
    gallery:
