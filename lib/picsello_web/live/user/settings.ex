defmodule PicselloWeb.Live.User.Settings do
  ...
  def settings_nav(assigns) do
    assigns = assigns |> Enum.into(%{container_class: "", intro_id: ""})

    ~H"""
    <div class="bg-blue-planning-100"><h1 class="px-6 py-8 text-3xl font-bold center-container">Your Settings</h1></div>

    <div class={"flex flex-col flex-1 px-6 center-container #{@container_class} #{@intro_id}"} {intro(@current_user, @intro_id)}>
