defmodule PicselloWeb.GalleryLive.PhotoComponent do
  ...
  defp toggle_border(js \\ %JS{}, id, is_gallery_category_page) do
    if is_gallery_category_page do
      ...
      |> JS.add_class(
        "before:absolute before:border-8 before:border-blue-planning-300 before:rounded-md before:left-0 before:top-0 before:bottom-0 before:right-0 before:z-10 selected",
        to: "#item-#{id}"
      )
    else
