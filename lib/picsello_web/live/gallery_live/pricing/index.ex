defmodule PicselloWeb.GalleryLive.Pricing.Index do
  ...
  def maybe_get_unlimited_dowloads?(gallery) do
    if get_pricing_value(gallery).download_count == 0 and get_pricing_value(gallery).download_each_price.amount == 0 do
      "All images included"
    else
