    ...
    <div class="flex flex-col justify-between">
      <div class="items-center mt-8">
        ...
        <div class=" mx-4 pt-4 flex flex-col justify-between" >
          ...
          <input type="checkbox" value="" id="checked-toggle" class="sr-only peer" phx-click="sell_product_enabled" checked={@product.sell_product_enabled} phx-target={@myself}>
        ...
        <label class="inline-flex relative items-center cursor-pointer">
          <input type="checkbox" value="" id="checked-toggle" class="sr-only peer" phx-click="product_preview_enabled" checked={@product.product_preview_enabled} phx-target={@myself}>
