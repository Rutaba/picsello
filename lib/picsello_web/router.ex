defmodule PicselloWeb.Router do
  ...
  scope "/stripe" do
    post(
      "/connect-webhooks",
      PicselloWeb.StripeWebhooksController,
      :connect_webhooks
    )
  ...
  scope "/gallery/:hash", PicselloWeb do
    live_session :gallery_client,
      on_mount: {PicselloWeb.LiveAuth, :gallery_client} do
      pipe_through(:browser)
  ...
  scope "/album/:hash", PicselloWeb do
    ...
    live_session :proofing_album_client,
      on_mount: {PicselloWeb.LiveAuth, :proofing_album_client} do
  ...
  scope "/gallery", PicselloWeb do
    live_session :gallery_client_login,
      on_mount: {PicselloWeb.LiveAuth, :gallery_client_login} do
      pipe_through([:browser])
