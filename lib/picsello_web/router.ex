defmodule PicselloWeb.Router do
  ...
  scope "/", PicselloWeb do
    ...
    live "/photographer/:organization_slug/pricing", Live.ProfilePricing, :index, as: :profile_pricing
    live "/photographer/:organization_slug/pricing/:job_type", Live.ProfilePricing, :index, as: :profile_pricing_job_type
  end
