defmodule Picsello.Repo.Migrations.TriggerOrganizationJobTypes do
  use Ecto.Migration
  ...
  def up do
    ...
    execute("""
      ...
      BEGIN
        ...
        SELECT false as "show_on_profile?", false as "show_on_business?", name, NEW.id, '#{now}' as inserted_at, '#{now}' as updated_at
        FROM job_types;
    ...
    CREATE TRIGGER insert_organization_job_types AFTER INSERT
      ON organizations FOR EACH ROW EXECUTE PROCEDURE ins_function(1, 666);
    """)
  end
