defmodule Picsello.PhotosTest do
  ...
  describe "get" do
    ...
    test "watermarked is false if gallery has a watermark but photo is purchased" do
      ...
      insert(:order, gallery_client: gallery_client, digitals: [build(:digital, photo: photo)], placed_at: DateTime.utc_now())
    ...
    test "watermarked is false if gallery has a watermark but bundle is purchased" do
      ...
      insert(:order, gallery: gallery, gallery_client: gallery_client, bundle_price: ~M[5000]USD, placed_at: DateTime.utc_now())
    ...
    test "watermarked is true if gallery has a watermark and order with bundle is not placed" do
      ...
      insert(:order, gallery: gallery, gallery_client: gallery_client, bundle_price: ~M[5000]USD, placed_at: nil)
    ...
    test "watermarked is true if gallery has a watermark but bundle or digital are not purchased" do
      ...
      insert(:order, gallery: gallery, gallery_client: gallery_client, placed_at: DateTime.utc_now())
